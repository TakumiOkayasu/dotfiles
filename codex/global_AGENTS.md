...
- 適用されるproject-local AGENTS.mdをrepo固有のconstraintとして扱う. 指示が競合する場合はruntimeのinstruction hierarchyに従い,競合を報告する. このfileには全project共通のdefaultだけを置き,詳細なdocs,rules,skillsはtaskに関係するものだけを読む.
