...
- `codex_tmp/failure_log/` ディレクトリが存在すること（なければ作成）
...
```
codex_tmp/failure_log/[連番範囲]-fail.md
...
**Step 1.** `codex_tmp/failure_log/` 内の全ファイルを列挙する
...
```
✅ 失敗記録: codex_tmp/failure_log/1-100-fail.md #[連番]
```
