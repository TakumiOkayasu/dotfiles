...
| 項目 | 内容 |
|------|------|
| チェックリスト | `codex/skills/qa-nightmare/checklists/*.md` が存在すること |
...
| テストケース連番IDに `TC-` を使うこと | `codex/skills/qa-nightmare/checklists/timing-chaos.md` のカテゴリID (TC-01〜TC-10) と衝突する。連番は `NM-001` 形式を使う |
...
各チェックリストは `codex/skills/qa-nightmare/checklists/` に格納。
...
```bash
ls codex/skills/qa-nightmare/checklists/*.md
```
