---
# codex_port_source: common/skills/instruction-surface-audit/SKILL.md
...
<!-- codex-port: managed; source=common/skills/instruction-surface-audit/SKILL.md; generated-by=scripts/port-claude-assets-to-codex.py -->

## Codex portability notes

- This file was ported from `common/skills/instruction-surface-audit/SKILL.md`.
