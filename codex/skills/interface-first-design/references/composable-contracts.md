...
<!-- codex-port: managed; source=common/skills/interface-first-design/references/composable-contracts.md; generated-by=scripts/port-claude-assets-to-codex.py -->

## Codex portability notes

- This file was ported from `common/skills/interface-first-design/references/composable-contracts.md`.
