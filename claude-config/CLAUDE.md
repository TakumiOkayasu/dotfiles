...
**┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓**
**┃ 行き詰まったら即座にClaudeに相談・Web検索・Deep Research ┃**
**┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛**

### 🔥 やるべきこと (遠慮するな！)

1. **Web検索** - 積極的に使え。エラーメッセージ、設定例、トラブルシュート
2. **Deep Research** - 複雑な問題は深掘り調査を依頼
3. **Claudeとの壁打ち** - スマホ・PCクライアントで相談OK
4. **公式ドキュメントのフェッチ** - WebFetchで一次情報を取得

### ⚡ 問題解決のスピードを上げるために

- 同じことを繰り返さない → 試した結果は報告書に記録
- 憶測で進めない → 必ず調査してから実行
- 一人で抱え込まない → Claudeに相談は許可されている
- 手詰まりで止まらない → 別のアプローチを即座に検討
